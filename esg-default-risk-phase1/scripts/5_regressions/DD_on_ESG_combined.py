"""
Regression: Distance to Default (DD) on Combined ESG Score
...
outfile = Path("esg-default-risk-phase1/scripts/5_regressions/results/DD_on_ESG_combined_results.csv")
